...
const FALLBACK_ROOMS: Record<string, { name: string; description: string; amenities: string[]; noticeActive?: boolean; noticeText?: string }> = {
  "ocean-deluxe": {
    name: "Ocean Deluxe",
...
export default async function RoomDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const image = ROOM_IMAGES[slug] || "/images/rooms/ocean-deluxe.jpg";
    ...
    <>
      ...
      <section className="bg-linen px-6 py-section-mobile tablet:px-14 tablet:py-section-tablet">
        <div className="mx-auto max-w-content space-y-10">
          <p className="max-w-editorial font-body text-body-lg leading-[1.7] text-driftwood">{room.description}</p>
