        ...
        <div className="mx-auto max-w-editorial space-y-8">
          ...
          <div className="mt-12 grid gap-8 tablet:grid-cols-3">
            <div className="text-center">
              <span className="font-display text-display-md font-semibold text-terracotta">16</span>
              <p className="mt-2 font-body text-body-md text-driftwood">Rooms</p>
            </div>
            <div className="text-center">
              <span className="font-display text-display-md font-semibold text-terracotta">100%</span>
              <p className="mt-2 font-body text-body-md text-driftwood">Solar Powered</p>
            </div>
            <div className="text-center">
              <span className="font-display text-display-md font-semibold text-terracotta">2014</span>
              <p className="mt-2 font-body text-body-md text-driftwood">Established</p>
            </div>
          </div>
        </div>
      </section>
